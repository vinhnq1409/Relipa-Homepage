        ...
        <div className="main-banner-item main-banner-item-sm">
          <div className="main-banner-item-bg">
            <picture>
              ...
              <img src="/user-page/img/aws/banner-sp.png" width="345" height="188" alt="Banner AWS Migration" />
            </picture>
          </div>
          <div className="container">
            <div className="section-heading section-heading-shadow">
              <h2 className="section-title" title={language.AWSMigration}>
                {language.AWSMigration}
              </h2>
            </div>
          </div>
        </div>
