export default {
  company: {
    ...
    profile: {
      ...
      Japanese_corporation: '日本法人',
      Company_Relipa: '会社名 株式会社レリパ',
      Established: '設立',
      jp2018: '2018年',
      CEO: '代表取締役',
      Chang_Suan_Duc: 'チャン・スアン・ドゥック',
      AddressJP: '日本住所',
      AddressVN: 'ベトナム住所',
      Address_Tokyo: '東京都渋谷区富ヶ谷1-14-14スタンフォードアネックスビル3F',
    ...
    CEOMessage: {
      CEO_Message: '代表メッセージ',
      content1:
        '株式会社レリパは、本社をベトナム・ハノイに構えるシステム開発会社で、2016年に立命館大学を卒業したベトナム人3名に設立されました。2018年には、日本法人も立ち上げて創業から一貫して「日本企業様向け」に特化したオフショア開発の提供を行っております。',
      content2:
        '21歳の時に日本に留学する機会がありました。 ベトナムのような発展途上国に住んでいて、先進国に初めて足を踏み入れる機会があった若い学生の私は、ベトナムでは見たことがない日本の鉄道などの公共建築、繊細で完璧なものづくりに本当に感銘を受けました。',
      content3:
        '卒業後、仕事で両国を行き来することが多く、両国の人々と接する中で、二国間を比較する機会が増えていきました。母国との大きなギャップを感じる反面、勉強中だったITについては「工業技術と比べれば、ベトナムと日本とのギャップは小さい」と感じたため、この分野の新しい技術にチャレンジし、母国のベトナム、そして日本にも貢献できるのではないかと考えるようになりました。',
      content4:
    ...
    MissionValues: {
      ...
      mission3: '従業員が自分自身に挑戦し、知識を共有し、共に成長するための環境を作ります',
      VISION: 'ヴィジョン',
      vision1: 'レリパは、テクノロジーの実装における信頼',
      vision2: 'できるパートナーおよび長期的なビジネスパートナーになることを目指しています',
      CORE_VALUES: 'コアバリュー',
      core_values1: 'プロアクティブ',
      core_values2: '創造',
      core_values3: '柔軟',
